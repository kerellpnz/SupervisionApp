    ...
    public class ScrewNutVM : ViewModelBase
    {
        ...
        public string Number
        {
            ...
            set
            {
                ...
                {
                    if (obj is ScrewNut item && item.Number != null)
                    {
        ...
        public string Drawing
        {
            ...
            set
            {
                ...
                allInstancesView.Filter += (obj) =>
                {
                    if (obj is ScrewNut item && item.Drawing != null)
                    {
        ...
        public string Status
        {
            ...
            set
            {
                ...
                allInstancesView.Filter += (obj) =>
                {
                    if (obj is ScrewNut item && item.Status != null)
                    {
        ...
        public string Material
        {
            ...
            set
            {
                ...
                allInstancesView.Filter += (obj) =>
                {
                    if (obj is ScrewNut item && item.Material != null)
                    {
        ...
        public string Melt
        {
            ...
            set
            {
                ...
                allInstancesView.Filter += (obj) =>
                {
                    if (obj is ScrewNut item && item.Melt != null)
                    {
        ...
        public string Certificate
        {
            ...
            set
            {
                ...
                allInstancesView.Filter += (obj) =>
                {
                    if (obj is ScrewNut item && item.Certificate != null)
                    {
            ...
            if (SelectedItem != null)
            {
                ...
                if (MainViewModel.HelpMode == true)
                {
                    MessageBox.Show("Поля внутри данного раздела заполняются в соответствии с их описанием, без добавления \"серт.\", " +
                        ...
                        "Вкладка \"Применяемость\" содержит таблицу ЗШ, в которых была применена текущая партия гаек и их количество.\n\n" +
                        "После заполнения нужных полей и закрытия операций, необходимо нажать кнопку \"Сохранить\".", "Раздел \"Редактирование гаек\"");
                }
            }
