...
{
    public class Ring047VM : ViewModelBase
    {
        private readonly DataContext db;
        private IList<Ring047> allInstances;
        ...
        public string ZK
        {
            ...
            set
            {
                ...
                {
                    if (obj is Ring047 item && item.ZK != null)
                    {
        ...
        public string DN
        {
            ...
            set
            {
                ...
                allInstancesView.Filter += (obj) =>
                {
                    if (obj is Ring047 item && item.DN != null)
                    {
        ...
        public string Number
        {
            ...
            set
            {
                ...
                allInstancesView.Filter += (obj) =>
                {
                    if (obj is Ring047 item && item.Number != null)
                    {
        ...
        public string Drawing
        {
            ...
            set
            {
                ...
                allInstancesView.Filter += (obj) =>
                {
                    if (obj is Ring047 item && item.Drawing != null)
                    {
        ...
        public string Status
        {
            ...
            set
            {
                ...
                allInstancesView.Filter += (obj) =>
                {
                    if (obj is Ring047 item && item.Status != null)
                    {
        ...
        public string Material
        {
            ...
            set
            {
                ...
                allInstancesView.Filter += (obj) =>
                {
                    if (obj is Ring047 item && item.Material != null)
                    {
        ...
        public string Melt
        {
            ...
            set
            {
                ...
                allInstancesView.Filter += (obj) =>
                {
                    if (obj is Ring047 item && item.Melt != null)
                    {
        ...
        public string Certificate
        {
            ...
            set
            {
                ...
                allInstancesView.Filter += (obj) =>
                {
                    if (obj is Ring047 item && item.Certificate != null)
                    {
        ...
        public IList<Ring047> AllInstances
        {
            get => allInstances;
            set
            {
        ...
        public static Ring047VM LoadVM(DataContext context)
        {
            Ring047VM vm = new Ring047VM(context);
        ...
        private async Task UpdateList()
        {
            try
            {
                ...
                AllInstances = new ObservableCollection<Ring047>();
        ...
        private async Task AddNewItem()
        {
            ...
            {
                IsBusy = true;
                SelectedItem = await repo.AddAsync(new Ring047());
                var tcpPoints = await repo.GetTCPsAsync();
                var records = new List<Ring047Journal>();
                foreach (var tcp in tcpPoints)
                {
                    var journal = new Ring047Journal(SelectedItem, tcp);
                    if (journal != null)
                        records.Add(journal);
                }
        ...
        private async Task CopySelectedItem()
        {
            if (SelectedItem != null)
            {
                try
                {
                    ...
                    var copy = await repo.AddAsync(new Ring047(temp));
                    var jour = new ObservableCollection<Ring047Journal>();
                    if (temp.Ring047Journals != null)
                    {
                        foreach (var i in temp.Ring047Journals)
                        {
                            var record = new Ring047Journal(copy.Id, i);
                            jour.Add(record);
                        }
                        ...
                        else
                        {
                            ...
                            if (System.Int32.TryParse(ring.Number, out int numb))
                            {
                                for (int y = 0; y < x; y++)
                                {
                                    ...
                                    var copy = await repo.AddAsync(new Ring047(ring));
                                    var jour = new ObservableCollection<Ring047Journal>();
                                    if (temp.Ring047Journals != null)
                                    {
                                        foreach (var i in temp.Ring047Journals)
        ...
        private void EditSelectedItem()
        {
            if (SelectedItem != null)
            {
                ...
                {
                    DataContext = Ring047EditVM.LoadVM(SelectedItem.Id, SelectedItem, db)
                };
                if (MainViewModel.HelpMode == true)
                {
                    MessageBox.Show("Поля внутри данного раздела заполняются в соответствии с их описанием, без добавления \"серт.\", " +
                        ...
                        "После заполнения нужных полей и закрытия операций, необходимо нажать кнопку \"Сохранить\".", "Раздел \"Редактирование Кольца(047)\"");
                }
            }
        ...
        public Ring047VM(DataContext context)
        {
            db = context;
