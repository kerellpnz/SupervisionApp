...
{
    public class CoverSleeve008VM : ViewModelBase
    {
        private readonly DataContext db;
        private IList<CoverSleeve008> allInstances;
        private ICollectionView allInstancesView;
        private CoverSleeve008 selectedItem;
        private readonly CoverSleeve008Repository repo;
        ...
        public string ZK
        {
            ...
            set
            {
                ...
                {
                    if (obj is CoverSleeve008 item && item.ZK != null)
                    {
        ...
        public string DN
        {
            ...
            set
            {
                ...
                allInstancesView.Filter += (obj) =>
                {
                    if (obj is CoverSleeve008 item && item.DN != null)
                    {
        ...
        public string Number
        {
            ...
            set
            {
                ...
                allInstancesView.Filter += (obj) =>
                {
                    if (obj is CoverSleeve008 item && item.Number != null)
                    {
        ...
        public string Drawing
        {
            ...
            set
            {
                ...
                allInstancesView.Filter += (obj) =>
                {
                    if (obj is CoverSleeve008 item && item.Drawing != null)
                    {
        ...
        public string Status
        {
            ...
            set
            {
                ...
                allInstancesView.Filter += (obj) =>
                {
                    if (obj is CoverSleeve008 item && item.Status != null)
                    {
        ...
        public string Material
        {
            ...
            set
            {
                ...
                allInstancesView.Filter += (obj) =>
                {
                    if (obj is CoverSleeve008 item && item.Material != null)
                    {
        ...
        public string Melt
        {
            ...
            set
            {
                ...
                allInstancesView.Filter += (obj) =>
                {
                    if (obj is CoverSleeve008 item && item.Melt != null)
                    {
        ...
        public string Certificate
        {
            ...
            set
            {
                ...
                allInstancesView.Filter += (obj) =>
                {
                    if (obj is CoverSleeve008 item && item.Certificate != null)
                    {
        ...
        public CoverSleeve008 SelectedItem
        {
            get => selectedItem;
            set
            {
        ...
        public IList<CoverSleeve008> AllInstances
        {
            get => allInstances;
            set
            {
        ...
        public static CoverSleeve008VM LoadVM(DataContext context)
        {
            CoverSleeve008VM vm = new CoverSleeve008VM(context);
        ...
        private async Task UpdateList()
        {
            try
            {
                ...
                AllInstances = new ObservableCollection<CoverSleeve008>();
        ...
        private async Task AddNewItem()
        {
            try
            {
                ...
                //CoverSleeve008 EmptyItem = new CoverSleeve008();
                //EmptyItem.MetalMaterial = Materials[0];
                //EmptyItem.MetalMaterialId = 1;

                SelectedItem = await repo.AddAsync(new CoverSleeve008());
                var tcpPoints = await repo.GetTCPsAsync();
                var records = new List<CoverSleeve008Journal>();
                foreach (var tcp in tcpPoints)
                {
                    var journal = new CoverSleeve008Journal(SelectedItem, tcp);
                    if (journal != null)
                        records.Add(journal);
                }
        ...
        private async Task CopySelectedItem()
        {
            if (SelectedItem != null)
            {
                try
                {
                    ...
                    var copy = await repo.AddAsync(new CoverSleeve008(temp));
                    var jour = new ObservableCollection<CoverSleeve008Journal>();
                    if (temp.CoverSleeve008Journals != null)
                    {
                        foreach (var i in temp.CoverSleeve008Journals)
                        {
                            var record = new CoverSleeve008Journal(copy.Id, i);
                            jour.Add(record);
                        }
            ...
            if (SelectedItem != null)
            {
                try
                {
                    ...
                    if (System.Int32.TryParse(Input, out int x))
                    {
                        ...
                        {
                            var temp = await repo.GetByIdIncludeAsync(SelectedItem.Id);
                            CoverSleeve008 detail = new CoverSleeve008(temp);
                            if (System.Int32.TryParse(detail.Number, out int numb))
                            {
                                for (int y = 0; y < x; y++)
                                {
                                    ...
                                    var copy = await repo.AddAsync(new CoverSleeve008(detail));
                                    var jour = new ObservableCollection<CoverSleeve008Journal>();
                                    if (temp.CoverSleeve008Journals != null)
                                    {
                                        foreach (var i in temp.CoverSleeve008Journals)
        ...
        private void EditSelectedItem()
        {
            if (SelectedItem != null)
            {
                ...
                {
                    DataContext = CoverSleeve008EditVM.LoadVM(SelectedItem.Id, SelectedItem, db)
                };
                if (MainViewModel.HelpMode == true)
                {
                    MessageBox.Show("Поля внутри данного раздела заполняются в соответствии с их описанием, без добавления \"серт.\", " +
                        ...
                        "После заполнения нужных полей и закрытия операций, необходимо нажать кнопку \"Сохранить\".", "Раздел \"Редактирование Втулки(008)\"");
                }
            }
        ...
        public CoverSleeve008VM(DataContext context)
        {
            db = context;
            repo = new CoverSleeve008Repository(db);
