...
{
    public class SlamShutterViewModel : BasePropertyChanged
    {
        private readonly DataContext db;
        private ObservableCollection<SlamShutter> allInstances;
                ...
                return editItem ?? (
                    editItem = new DelegateCommand<Window>((w) =>
                    {
                        if (SelectedItem != null)
                        {
                            ...
                            var vm = new SlamShutterEditViewModel(SelectedItem);
                            wn.DataContext = vm;
                            w?.Close();
                            wn.ShowDialog();
                        }
                ...
                return addItem ?? (
                    addItem = new DelegateCommand<Window>((w) =>
                    {
                        ...
                        foreach (var i in tcpPoints)
                        {
                            ...
                            {
                                SlamShutterId = SelectedItem.Id,
                                SlamShutterTCPId = i.Id
                            };
                            if (journal != null)
                            {
        ...
        public ObservableCollection<SlamShutter> AllInstances
        {
